...
change_tab_store() ->
	...
	lists:foreach(fun(Vc) ->
	    ...
	    ejabberd_odbc:sql_transaction(LServer,fun() ->
    	              odbc_queries:update_t(<<"vcard">>,
						 [<<"username">>,  <<"vcard">>],
						 [ejabberd_odbc:escape(LUser), ejabberd_odbc:escape(xml:element_to_binary(VCARD))],
	...
	lists:foreach(fun(Vc1) ->
	    ...
	    ejabberd_odbc:sql_transaction(LServer,fun() ->
			  odbc_queries:update_t(<<"vcard_search">>,
						   [<<"username">>,
						    <<"lusername">>, <<"fn">>,
						    <<"lfn">>, <<"family">>,
						    <<"lfamily">>, <<"given">>,
